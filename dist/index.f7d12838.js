...
})({"5ytRy":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
const updateGame = ()=>{
    ...
    if (keyMap['ArrowRight'] && ship.x < window.innerWidth - 80) ship.moveRight();
    else if (keyMap['ArrowLeft'] && ship.x > 30) ship.moveLeft();
    // firing the ammo
    if (keyMap[' ']) // Firing mechanism
    ship.fireControl({
        createAmmo
    });
...
class Ship extends _elementEntity.ElementEntity {
    constructor(){
        super({
            tag: 'div',
            className: 'ship'
...
},{"./ElementEntity":"lvWQr","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lvWQr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Contains the basic principle functions and element creation function
parcelHelpers.export(exports, "ElementEntity", ()=>ElementEntity
);
class ElementEntity {
...
},{}],"jAA3a":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./ElementEntity":"lvWQr","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lYarv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WeaponStock", ()=>WeaponStock
);
var _elementEntity = require("./ElementEntity");
class WeaponStock extends _elementEntity.ElementEntity {
    constructor({ x , y  }){
        super({
            tag: 'div',
